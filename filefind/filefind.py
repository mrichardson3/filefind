...
"""Usage: filefind.py
    ...
    filefind.py -u id [--name name --path name --any name --ext name --size <range> --date <range>]
...
def query_mode(*args, **kwargs):
    ...
    query_results =  run_query(database_key = query_this_path,
                               ...
                               worker_filter = default_filter_function)

    print('Sorting the final report')
    sorted_results = sort_table(query_results, ('date+','name-', 'sha1+'))
